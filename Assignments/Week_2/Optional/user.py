...
user_john=User('John','Doe','john@doe.com',25).display_info().enroll().spend_points(50)
user_john.display_info()
user_john.enroll()


user_jane=User('Jane','Doe','jane@doe.com',27).enroll().spend_points(80)
...
user_john.enroll().display_info()
#user_john.display_info()

#implementing and testing ovespend logic
#user_gene.gold_card_points=30
user_gene.display_info().spend_points(40).display_info()
'''
user_gene.display_info()
